...
public:
    ...
    void PullCheckBoxesStates()
    {
        ...
        is_teleport_ = Button_GetCheck(GetDlgItem(hwnd_, IDC_TRIGGER_TELEPORT)) == BST_CHECKED; // reused for ignore resets
    }
    ...
    void UpdateCheckBoxesStates()
    {
        ...
        CheckDlgButton(hwnd_, IDC_TRIGGER_TELEPORT, is_teleport_ ? BST_CHECKED : BST_UNCHECKED); // reused for ignore resets
    }
