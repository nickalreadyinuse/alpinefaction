...
namespace gr::d3d11
{
    ...
    ComPtr<ID3D11SamplerState> StateManager::create_sampler_state(rf::gr::TextureSource ts, bool picmip_active)
    {
        ...
        switch (ts) {
            ...
            case rf::gr::TEXTURE_SOURCE_MT_WRAP_TRILIN: // WRAP_1_WRAP_0
                desc.AddressU = D3D11_TEXTURE_ADDRESS_WRAP;
                desc.AddressV = D3D11_TEXTURE_ADDRESS_WRAP;
                break;
            case rf::gr::TEXTURE_SOURCE_CLAMP:
            case rf::gr::TEXTURE_SOURCE_CLAMP_1_CLAMP_0:
            case rf::gr::TEXTURE_SOURCE_MT_CLAMP_TRILIN: // WRAP_1_CLAMP_0
    ...
    ComPtr<ID3D11BlendState> StateManager::create_blend_state(const rf::gr::AlphaBlend ab) {
        ...
        switch (ab) {
            case rf::gr::ALPHA_BLEND_NONE: {
                desc.RenderTarget[0].BlendEnable = FALSE;
                break;
            }
            case rf::gr::ALPHA_BLEND_ADDITIVE: {
                desc.RenderTarget[0].BlendEnable = TRUE;
                desc.RenderTarget[0].SrcBlend = D3D11_BLEND_ONE;
                desc.RenderTarget[0].DestBlend = D3D11_BLEND_ONE;
                break;
            }
            case rf::gr::ALPHA_BLEND_ALPHA_ADDITIVE:
            case rf::gr::ALPHA_BLEND_SRC_COLOR: {
                desc.RenderTarget[0].BlendEnable = TRUE;
                desc.RenderTarget[0].SrcBlend = D3D11_BLEND_SRC_ALPHA;
                desc.RenderTarget[0].DestBlend = D3D11_BLEND_ONE;
                break;
            }
            case rf::gr::ALPHA_BLEND_ALPHA: {
                desc.RenderTarget[0].BlendEnable = TRUE;
                desc.RenderTarget[0].SrcBlend = D3D11_BLEND_SRC_ALPHA;
                desc.RenderTarget[0].DestBlend = D3D11_BLEND_INV_SRC_ALPHA;
                break;
            }
            case rf::gr::ALPHA_BLEND_LIGHTMAP: {
                desc.RenderTarget[0].BlendEnable = TRUE;
                desc.RenderTarget[0].SrcBlend = D3D11_BLEND_DEST_COLOR;
                desc.RenderTarget[0].DestBlend = D3D11_BLEND_ZERO;
                break;
            }
            case rf::gr::ALPHA_BLEND_SUBTRACTIVE: {
                desc.RenderTarget[0].BlendEnable = TRUE;
                desc.RenderTarget[0].SrcBlend = D3D11_BLEND_INV_DEST_COLOR;
                desc.RenderTarget[0].DestBlend = D3D11_BLEND_ZERO;
                break;
            }
            case rf::gr::ALPHA_BLEND_SWAPPED_SRC_DEST_COLOR: {
                desc.RenderTarget[0].BlendEnable = TRUE;
                desc.RenderTarget[0].SrcBlend = D3D11_BLEND_DEST_COLOR;
    ...
    ID3D11DepthStencilState* StateManager::get_outline_stencil_mark_state()
    {
        if (!outline_stencil_mark_state_) {
            ...
            desc.DepthFunc = (rf::gr::screen.depthbuffer_type == rf::gr::DEPTHBUFFER_Z)
    ...
    ComPtr<ID3D11DepthStencilState> StateManager::create_depth_stencil_state(rf::gr::ZbufferType zbt)
    {
        ...
        if (rf::gr::screen.depthbuffer_type == rf::gr::DEPTHBUFFER_Z) {
        ...
        switch (zbt) {
        case rf::gr::ZBUFFER_TYPE_NONE:
            desc.DepthEnable = FALSE;
            desc.DepthWriteMask = D3D11_DEPTH_WRITE_MASK_ZERO;
            break;
        case rf::gr::ZBUFFER_TYPE_READ:
            desc.DepthEnable = TRUE;
            desc.DepthWriteMask = D3D11_DEPTH_WRITE_MASK_ZERO;
            break;
        case rf::gr::ZBUFFER_TYPE_READ_EQUAL:
            desc.DepthEnable = TRUE;
            desc.DepthWriteMask = D3D11_DEPTH_WRITE_MASK_ZERO;
            desc.DepthFunc = D3D11_COMPARISON_EQUAL;
            break;
        case rf::gr::ZBUFFER_TYPE_WRITE:
            desc.DepthEnable = TRUE;
            desc.DepthWriteMask = D3D11_DEPTH_WRITE_MASK_ALL;
            desc.DepthFunc = D3D11_COMPARISON_ALWAYS;
            break;
        case rf::gr::ZBUFFER_TYPE_FULL:
        case rf::gr::ZBUFFER_TYPE_FULL_ALPHA_TEST:
            desc.DepthEnable = TRUE;
            desc.DepthWriteMask = D3D11_DEPTH_WRITE_MASK_ALL;
            break;
        }
